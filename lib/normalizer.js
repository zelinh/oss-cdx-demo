...
module.exports = {
    ...
    getAliasName: (project, prefix = prefixes.sboms, suffix = '') => prefix + normalizeName(project.name) + '~' + normalizeTag(project.tag) + suffix,
    getIndexName: (project, prefix = 'raw-' + prefixes.sboms, suffix = '') => prefix + normalizeName(project.name) + '-' + normalizeTag(project.tag) + '-' + project.hash + suffix,
}