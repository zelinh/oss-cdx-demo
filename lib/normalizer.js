...
module.exports = {
    ...
    getAliasName: (project, prefix = 'cdx-', suffix = '') => prefix + normalizeName(project.name) + '~' + suffix,
    getIndexName: (project, prefix = 'raw-cdx-', suffix = '') => prefix + normalizeName(project.name) + '-' + hashTimestamp(project.timestamp) + suffix,
}