...
const lockProgressState = async (project, stage) => {
    if (!stage || !project || !project.name || !project.hash || !project.tag) return;
...
const releaseProgressState = async (id, stage) => {
    if (!stage || !id) return;
